...
$LANGS['shorttimeformat'] = '%A, la %e-an de %B %Y';
$LANGS['videotimeformat'] = '%A, la %e-an de %B %Y';
$LANGS['longtimeformat'] = '%A, la %e-an de %B %Y';
$LANGS['timehourformat'] = '%A, la %e-an de %B %Y %I:%M %p';
$LANGS['myvideostimeformat'] = '%A, la %e-an de %B %Y, %I:%M:%S %p';
$LANGS['blogpostformat'] = '%A, la %e-an de %B %Y';
...
$LANGS['help'] = 'Helpu';
$LANGS['suggestions'] = 'Sugestoj';
$LANGS['quicklist'] = 'Rapida Listo';
...
$LANGS['modules'] = "Aldoni aŭ Forigi Modulojn";
$LANGS['friendactivity'] = "Amika Agado";
$LANGS['customizehomepage'] = "Agordu Hejmpaĝon";
$LANGS['customizethehomepage'] = "Agordu la Hejmpaĝon";
$LANGS['customizehomepagedesc'] = "Elektu la modulojn, kiujn vi volas vidi en via personecigita hejmpaĝo.";
$LANGS['displaypreferences'] = "Montraj Preferoj";
$LANGS['thefeed'] = "fluon";
$LANGS['thefeeddesc'] = "Kombinu ĉiujn viajn modulojn en ununuran fluon.";
$LANGS['friendactivitytitle'] = "Amika Agado - Ĉu homoj povas vidi kion mi faras?";
$LANGS['friendactivitydesc'] = "Ĉi tiu sekcio montras al viaj konfirmitaj amikoj la agojn, kiujn vi publike dissendas en via lastatempa agadhistorio. Ekzemple, se vi ŝatatas videon, tiam via nova plej ŝatata video eble aperos en la Lastatempa Agado de via kanalo, same kiel en la hejmpaĝoj de viaj amikoj.";
$LANGS['feedfeatured'] = "Elstara Video";
$LANGS['feedbeingwatched'] = "Video Estas Rigardata Nun";
$LANGS['feedrecommended'] = "Rekomendita Video";
$LANGS['nosubscriptions'] = "Vi ankoraŭ ne abonis iun kanalon.";
$LANGS['nosubscriptionsdesc'] = "Kiam vi aldonas novajn abonojn, ni montros iliajn alŝutojn ĉi tie sur ĉi tiu paĝo.";
$LANGS['nofriendactivity'] = "Viaj amikoj lastatempe ne aktivis.";
$LANGS['nofriendactivitydesc'] = "Vi povas provi aldoni kelkajn amikojn. Poste, ni montros ilian agadon ĉi tie sur ĉi tiu paĝo.";
$LANGS['homeediting'] = "Redaktado";
$LANGS['homedisplay'] = "Montru kiel";
$LANGS['homerows'] = "Nombro de vicoj por montri";
$LANGS['gridview'] = "Krada Vido";
$LANGS['listview'] = "Listo Vido";
...
$LANGS['partnerprogram'] = "La partnera programo de BitView";
...
$LANGS['uploaddisabled'] = 'Alŝuto estas malŝaltita por prizorgado.';
$LANGS['10vidsday'] = 'Vi ne povas alŝuti pli ol 10 filmetojn ĉiutage! Bonvolu provi alŝuti morgaŭ.';
$LANGS['3mins'] = 'Atendu 3 minutojn ĝis vi alŝutos novan videon!';
$LANGS['backgroundsuccess'] = 'Fono estis sukcese alŝutita!';
$LANGS['backgrounderror'] = 'Fonbildo devas esti malpli ol 2MB kaj esti bilddosiero!';
$LANGS['backgrounddeleted'] = 'Fono estis sukcese forigita!';
$LANGS['bannersuccess'] = 'Standardo estis sukcese alŝutita!';
...
/* Watch */
$LANGS['moreinfo'] = 'pli da informoj';
$LANGS['lessinfo'] = 'malpli da informoj';
$LANGS['category'] = 'Kategorio';
