...
/* Watch */
$LANGS['moreinfo'] = 'més infomació';
$LANGS['lessinfo'] = 'menys informació';
$LANGS['category'] = 'Categoria';
$LANGS['recordedon'] = 'Data de gravació';
$LANGS['location'] = 'Ubicació';
$LANGS['tags'] = 'Etiquetes';
$LANGS['embed'] = 'Incrustar';
$LANGS['partnervideo'] = 'Vídeo de partner';
$LANGS['subscribe'] = 'Suscribir-se';
$LANGS['unsubscribe'] = 'Anul·lar subscripció';
$LANGS['nodesc'] = 'Sense descripció...';
$LANGS['logintosub'] = 'Inicia la sessió per a suscribir-te.';
$LANGS['logintosubbox'] = 'Vols suscribir-te?';
$LANGS['subyourself'] = 'No et pots subscriure a tu mateix!';
...
$LANGS['changeplayersize'] = 'Canviar el tamany del reproductor';
$LANGS['newwindow'] = 'Mirar aquest vídeo en una finestra nova';
$LANGS['featuredtext'] = 'Aquest vídeo ha sigut destacat. Vols veure més vídeos destacats? <a href="/browse?t=2">Clica aquí</a>.';
$LANGS['ratings'] = 'puntuacions';
$LANGS['rating'] = 'puntuació';
$LANGS['favorite'] = 'Favorits';
$LANGS['addtofav'] = 'Afegir a favorits';
$LANGS['removefav'] = 'Eliminar de favorits';
$LANGS['playlistdesc'] = 'Per a afegir un vídeo a una llista de reproducció, aneu a la pàgina <a href="/my_playlists">"Les meves llistes de reproducció"</a>';
$LANGS['share'] = 'Compartir';
$LANGS['flag'] = 'Marcar';
$LANGS['flagthisvid'] = 'Marcar aquest vídeo';
$LANGS['removeflag'] = 'Eliminar marca';
$LANGS['flagnote'] = "Abans de denunciar un vídeo, assegura't que el vídeo incompleix qualsevol regla. No denuncis només perquè no t'agrada aquest vídeo, en cas contrari dificultaràs la feina dels moderadors.";
...
$LANGS['statsdata'] = 'Estadístiques i informació';
$LANGS['honors'] = "Guardons d'aquest vídeo";
$LANGS['mostviewed'] = 'Més vists';
...
$LANGS['responsespost'] = 'Publicar una resposta en vídeo';
$LANGS['textcomments'] = 'Comentaris escrits';
$LANGS['commentpost'] = 'Escriu un comentari';
$LANGS['commentonthisvideo'] = 'Comenta en aquest vídeo';
$LANGS['postcomment'] = 'Publicar comentari';
$LANGS['remainingcounter'] = 'Nombre de caràcters restants';
$LANGS['nocomments'] = 'Aquest vídeo <b>no té comentaris</b>.';
$LANGS['nocomments'] = 'Aquest vídeo <b>no té respostes</b>.';
$LANGS['commviewall'] = 'Veure els';
$LANGS['delete'] = 'Eliminar';
$LANGS['reply'] = 'Respondre';
$LANGS['commentlogin'] = 'Vols enviar algun comentari?';
$LANGS['commentlogindesc'] = "<a href='/signup'>Crea't un compte a BitView</a> de forma gratuita o <a href='/login'>inicia sessió</a> si ja t'has registrat.";
$LANGS['logintoresponse'] = 'Inicia la sessió per a afegir una resposta en vídeo';
$LANGS['logintocomment'] = 'Inicia la sessió per a publicar un comentari';
$LANGS['logintofav'] = 'Vols afegir aquest vídeo als teus favorits? <a href="/login">Inicia la sessió</a> o <a href="/signup">Crea un compte</a> ara!';
$LANGS['logintopl'] = 'Vols afegir aquest vídeo a una llista de reproducció? <a href="/login">Inicia la sessió</a> o <a href="/signup">Crea un compte</a> ara!';
$LANGS['logintoflag'] = 'Vols marcar aquest vídeo? <a href="/login">Inicia la sessió</a> o <a href="/signup">Crea un compte</a> ara!';
$LANGS['close'] = 'tancar';
...
/* Sign In */
$LANGS['username'] = "Nom d'usuari";
$LANGS['password'] = "Contrasenya";
$LANGS['logindesc'] = "Inicia la sessió al teu compte de BitView";
$LANGS['forgot'] = "No pots accedir al teu compte?";
$LANGS['forgotmsg'] = 'Poseu-vos en contacte amb nosaltres a Twitter (@BitView_) o envieu un missatge als moderadors del Discord. (enllaç al peu de pàgina)';
$LANGS['noaccount'] = "No tens un compte?";
$LANGS['signuptobv'] = "Crea un compte en BitView!";
$LANGS['signintobv'] = "Inicia la sessió a BitView!";
$LANGS['signindesc1'] = "Uneix-te a la comunitat per compartir vídeos més gran del món!";
$LANGS['signindesc2'] = "BitView és una manera de fer arribar els teus vídeos a les persones que t'importen. Amb BitView pots:";
$LANGS['signindesc3'] = "Mostrar els teus vídeos preferits al món";
$LANGS['signindesc4'] = "Publicar els vídeos que feu amb la vostra càmera digital o telèfon mòbil";
$LANGS['signindesc5'] = "Mostrar vídeos de manera segura i privada als teus amics i familiars de tot el món";
$LANGS['notallowed'] = "Ja t'han suspés 3 vegades. Ja no tens permís per utilitzar BitView!";
$LANGS['wrongpassword'] = 'Aquesta contrasenya és incorrecta.';

/* Sign Up */
$LANGS['email'] = "Direcció de correu electrònic";
$LANGS['passwordstrength'] = "Nivell de seguretat de la contrasenya:";
$LANGS['psnone'] = "Ningua";
$LANGS['psweak'] = "Feble";
$LANGS['psfair'] = "Regular";
$LANGS['psgood'] = "Bo";
$LANGS['psstrong'] = "Fort";
$LANGS['repassword'] = "Torna a escriure la contrasenya";
$LANGS['usernamedesc'] = "El vostre nom d'usuari només pot contenir lletres A-Z o números 0-9.";
$LANGS['captcha'] = "Captcha";
$LANGS['acceptterms'] = "Accepte les <a href='/terms'>Condicions d'ús</a> and <a href='/privacy'>Privacy Policy</a>.";
$LANGS['copyrighttext'] = "Penjar materials que no són propietaris és una violació dels drets d'autor i contra la llei. Si carregueu material que no teniu, el vostre compte se suprimirà.";
$LANGS['mustaccept'] = "Heu d'acceptar les Condicions d'ús i la Política de privacitat per crear el vostre compte.";
$LANGS['createaccount'] = 'Crear el meu compte';
$LANGS['signuperror'] = "S'ha produït un error a l'hora de crear el vostre compte.";
$LANGS['sameemail'] = "Aquest nom d'usuari o correu electrònic ja està en ús!";
$LANGS['usernamechar'] = "Els noms d'usuari només poden contenir caràcters i números!";
$LANGS['required'] = 'Cal omplir tots els camps de text!';
$LANGS['notmatch'] = "Les contrasenyes no coincideixen!";
$LANGS['signuphead'] = 'Crear el teu compte de BitView';
...
$LANGS['nomorevideos'] = "No s'han trobat més vídeos...";
$LANGS['timetoday'] = 'Hui';
...
$LANGS['nochannels'] = "No s'han trobat més canals...";

/* Video Categories */
$LANGS['cat1'] = "Cinema i animació";
$LANGS['cat2'] = "Automoció";
$LANGS['cat3'] = "Educació";
$LANGS['cat4'] = "Lleure";
$LANGS['cat5'] = "Events i casaments";
$LANGS['cat6'] = "Família";
$LANGS['cat7'] = "Per a la venda i subhastes";
$LANGS['cat8'] = "Aficions i interessos";
$LANGS['cat9'] = "Humor";
$LANGS['cat10'] = "Música";
$LANGS['cat11'] = "Notícies i política";
$LANGS['cat12'] = "Extrany i escandalós";
$LANGS['cat13'] = "Gent i blocs";
$LANGS['cat14'] = "Cites";
$LANGS['cat15'] = "Mascotes i animals";
$LANGS['cat16'] = "Ciència i tecnologia";
$LANGS['cat17'] = "Curtmetratges";
$LANGS['cat18'] = "Esports";
$LANGS['cat19'] = "Viatges i Events";
$LANGS['cat20'] = "Jocs";
$LANGS['cat21'] = "Videoblocs";

/* Channel Types */
$LANGS['type0'] = "Ningun";
$LANGS['type1'] = "Membre";
$LANGS['type1p'] = "Membres";
$LANGS['type2'] = "Comediant";
$LANGS['type2p'] = "Comediants";
...
$LANGS['type5'] = "Músic";
$LANGS['type5p'] = "Músics";
$LANGS['type6'] = "Periodista";
$LANGS['type6p'] = "Periodistes";
...
$LANGS['footmore'] = 'més...';
$LANGS['helpinfo'] = 'Ajuda i informació';
