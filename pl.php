...
$LANGS['unsubscribe'] = 'Anuluj subskrypcję';
...
$LANGS['recentratings'] = 'Ostatnie oceny';
...
$LANGS['ratingsbox'] = 'Skrzynka ocen';
...
$LANGS['contentpartners'] = 'Partnerzy treści';
...
$LANGS['aboutguidelines'] = 'O Wytycznych BitView';
$LANGS['aboutguidelinesdesc'] = "Wytyczne BitView powinny być zrozumiałe i łatwe do zrozumienia. Staramy się, aby były one dostosowane do różnych typów ludzi. Prosimy o przestrzeganie kilku zasad, a nie wpadniesz w tarapaty!";
$LANGS['therules'] = 'Zasady';
$LANGS['rule1'] = "Filmy przedstawiające akty seksualne nie są dozwolone. Dotyczy to także animacji!";
$LANGS['rule2'] = "Spamowanie na profilach, w komentarzach, wiadomościach i raportach nie jest dozwolone.";
$LANGS['rule3'] = "Filmy promujące ekstremistyczne ideologie w pozytywnym świetle nie są dozwolone.";
$LANGS['rule4'] = "Filmy i nazwy profili, które promują szkodę/nękanie wobec osób/firm/grup, nie są dozwolone.";
$LANGS['rule5'] = "Filmy i obrazy profilowe zawierające przemoc, tortury, samobójstwa, ścięcia głów, strzelaniny, zabijanie, miażdżenie żywych istot i rozrywanie skóry nie są dozwolone. Animowana/kartoonizowana przemoc jest dozwolona, ale nie może być tak realistyczna, żeby można ją było uznać za autentyczną.";
$LANGS['rule6'] = "Filmy zawierające znęcanie się nad zwierzętami nie są dozwolone.";
$LANGS['rule7'] = "Reklamy usług lub stron internetowych w formie filmów lub komentarzy nie są dozwolone.";
$LANGS['rule8'] = "Nie próbuj siłą brutalną przejąć konta, którego nie posiadasz.";
$LANGS['rule9'] = "Nie korzystaj z więcej niż jednego konta do oceniania filmów i/lub komentarzy. Nie wolno Ci również używać wielu kont alternatywnych do subskrybowania siebie.";
...
/* Share */
$LANGS['sharevideo'] = 'Jak udostępnić swoje wideo BitView?';
$LANGS['sharepvideo'] = 'Jak udostępnić moje prywatne filmy znajomym?';
$LANGS['sharechannellist'] = 'Jak wyświetlić moje filmy z BitView na mojej stronie internetowej?';
$LANGS['sharevideo1'] = 'Najpierw przejdź do wideo, które chcesz udostępnić. Szukaj pola pod odtwarzaczem wideo i tagami.';
$LANGS['sharevideo2'] = 'Teraz zobaczysz dwie metody udostępniania wideo:';
$LANGS['sharevideo3'] = '1. <b>URL wideo</b>: Ten adres URL przeniesie cię bezpośrednio do strony BitView i natychmiast rozpocznie odtwarzanie wideo. Wyślij link do kogoś za pomocą e-maila lub programów czatowych.';
$LANGS['sharevideo4'] = '2. <b>Osadź</b>: Skopiuj poniższy kod HTML na swoją stronę internetową, a odtwarzacz wideo BitView pojawi się na niej. Nie będzie odtwarzany automatycznie i trzeba na niego kliknąć, aby rozpocząć odtwarzanie. Zamień <i>"XXXXX"</i> na identyfikator wideo.';
$LANGS['sharepvideo1'] = "Aby przyjaciele i rodzina mogli oglądać twoje prywatne filmy, muszą najpierw założyć konto na BitView. Gdy już znasz nazwę konta, przejdź do ich kanału i kliknij przycisk <i>Dodaj jako przyjaciela</i> po prawej stronie. Teraz muszą tylko zaakceptować prośbę o przyjaźń, a będą mogli oglądać twoje prywatne filmy.<br><b>Możesz również dodać przyjaciela, po prostu wprowadzając ich nazwę użytkownika poniżej:</b>";
