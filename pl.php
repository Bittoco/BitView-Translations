...
$LANGS['revert'] = "Chcę wrócić do starego wyglądu kanału";
$LANGS['all'] = "Wszystkie";
$LANGS['uploads'] = "Wideo";
$LANGS['channelpl'] = "Playlisty";
$LANGS['backtoplaylists'] = "Powrót do playlist";
$LANGS['searchuploads'] = "Szukaj wideo";
...
$LANGS['pastethislink'] = "Wklej ten link do e-maila lub wiadomości";
$LANGS['selectplaylist'] = "Wybierz Playlistę";
$LANGS['profilemsg'] = 'Widzowie Twojego kanału zobaczą tutaj linki, takie jak "subskrybuj" i "dodaj jako przyjaciela".';
$LANGS['profile'] = 'Profil';
$LANGS['profilechangessaved'] = 'Zmiany zapisane.';
$LANGS['posting'] = 'wysyłanie...';
$LANGS['name'] = 'Imię';
$LANGS['totaluploadviews'] = 'Ogólna liczba wyświetleń wideo';
$LANGS['channeldesc'] = 'Opis kanału';
$LANGS['hometown'] = 'Miejscowość';
$LANGS['occupation'] = 'Zawód';
$LANGS['companies'] = 'Firmy';
$LANGS['schools'] = 'Szkoły';
$LANGS['interests'] = 'Zainteresowania';
$LANGS['movies'] = 'Filmy';
$LANGS['featuredchannelsdefault'] = 'Kliknij przycisk "edytuj" powyżej, aby wprowadzić kanały, do których chcesz linkować.';
$LANGS['featuredchannelsdesc'] = 'Podaj 4 kanały docelowe w kolejności, w jakiej chcesz, żeby były wyświetlane na Twoim kanale, oddzielone przecinkami, bez spacji. Niepodanie żadnych kanałów spowoduje, że to pole nie będzie wyświetlane na Twoim kanale.';
$LANGS['backtochannel'] = "powrót do kanału {c}";
$LANGS['refresh'] = "Odśwież";
$LANGS['whichcontent'] = "Jaką zawartość chciałbyś wyświetlać?";
$LANGS['myuploadedvideos'] = "Moje wideo";
$LANGS['myfavorites'] = "Moje ulubione";
$LANGS['alsoshowall'] = 'Pokaż także widok "Wszystkie"';
...
$LANGS['areyousure'] = "Jesteś pewien, że chcesz kontynuować?";
$LANGS['unsavedchanges'] = "Jesteś pewien, że chcesz zmienić motyw? Niezapisane zmiany zostaną utracone.";
$LANGS['showadvancedoptions'] = "pokaż opcje zaawansowane";
$LANGS['hideadvancedoptions'] = "ukryj opcje zaawansowane";
$LANGAS['general'] = "Ogólne";
$LANGS['colorpalettes'] = "Palety kolorów";
$LANGS['font'] = "Czcionka";
$LANGS['wrappercolor'] = "Kolor obwódki";
$LANGS['wrappertextcolor'] = "Kolor tekstu obwódki";
$LANGS['wrapperlinkcolor'] = "Kolor linków obwódki";
$LANGS['wrappertransparency'] = "Przezroczystość obwódki";
$LANGS['repeatbackground'] = "Powtarzaj tło";
$LANGS['titletextcolor'] = "Kolor tekstu tytułu";
$LANGS['bodytextcolor'] = "Kolor tekstu treści";
$LANGS['transparency'] = "Przezroczystość";
$LANGS['bgimgdesc'] = "Prześlij obraz, który będzie wyświetlany jako tło na Twoim kanale (maksymalnie 2MB).";
...
$LANGS['profilesetup'] = 'Konfiguracja profilu';
$LANGS['playbacksetup'] = 'Konfiguracja odtwarzania';
$LANGS['emailoptions'] = 'Opcje e-mail';
$LANGS['manageaccount'] = 'Zarządzaj kontem';
$LANGS['chvideoviews'] = 'Odsłony wideo';
$LANGS['change'] = "zmień";
$LANGS['mynetwork'] = "Moja sieć";
$LANGS['contacts'] = "Kontakty";
$LANGS['chvideocomments'] = "Komentarze do wideo";
$LANGS['chmore'] = "Więcej";
$LANGS['changepicture'] = "Zmień obraz";
$LANGS['changepicturedesc'] = "Możesz przesłać plik JPG, BMP lub PNG. Nie przesyłaj zdjęć zawierających celebrytów, nagie treści, dzieła sztuki ani obrazy chronione prawem autorskim. Twój obraz będzie wyświetlany jako kwadrat o rozmiarze 88px na 88px. <b>Maksymalny rozmiar pliku to 2 MB.</b>";
...
$LANGS['videoplaybackqualitydesc'] = "Wybierz domyślne ustawienie dla odtwarzania wideo";
$LANGS['alwayshd'] = "Zawsze odtwarzaj wideo w jakości HD";
$LANGS['neverhd'] = "Nigdy nie odtwarzaj żadnych wideo w jakości HD";
$LANGS['currentemail'] = "Obecny adres e-mail";
$LANGS['changeemailaddress'] = "Zmień adres e-mail";
$LANGS['changeemail'] = "Zmień e-mail";
...
$LANGS['timemachinedesc'] = "Przesuń się wstecz w czasie, cofając każdą datę na BitView do późnych lat 2000.";
$LANGS['lightsout'] = "Wyłącz światło";
$LANGS['lightsoutdesc'] = "Męczy cię jasność na ekranie? Zamień ją na czarny kolor i wypróbuj nowy, chłodny interfejs.";
$LANGS['featherenabled'] = '"Tryb piórka" jest teraz włączony!';
$LANGS['timemachineenabled'] = '"Wehikuł Czasu" jest teraz włączony!';
$LANGS['lightsoutenabled'] = '"Wyłącz światło" jest teraz włączone!';
$LANGS['featherdisabled'] = '"Tryb piórka" jest teraz wyłączony!';
$LANGS['timemachinedisabled'] = '"Wehikuł Czasu" jest teraz wyłączony!';
$LANGS['lightsoutdisabled'] = '"Wyłącz światło" jest teraz wyłączony!';
