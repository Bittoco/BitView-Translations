...
$LANGS['addfavorite2'] = 'видео в избранные!';
...
$LANGS['backgrounderror'] = 'Фоновое изображение должно быть картинкой размером не более 2MB!';
$LANGS['backgrounddeleted'] = 'Фоновое изображение успешно удалено!';
$LANGS['bannersuccess'] = 'Баннер успешно загружен!';
$LANGS['bannererror'] = 'Баннер должен быть картинкой размером не более 2MB!';
$LANGS['bannerdeleted'] = 'Баннер успешно удален!';
$LANGS['minibannersuccess'] = 'Мини-баннер успешно загружен!';
$LANGS['minibannererror'] = 'Мини-баннер должен быть картинкой размером не более 2MB!';
$LANGS['minibannerdeleted'] = 'Мини-баннер успешно удален!';
$LANGS['sideimagesuccess'] = 'Боковой баннер успешно загружен!';
$LANGS['sideimageerror'] = 'Боковой баннер должен быть картинкой размером не более 2MB!';
$LANGS['sideimagedeleted'] = 'Боковой баннер успешно удален!';
$LANGS['avatarsuccess'] = 'Аватар успешно загружен!';
$LANGS['avatarerror'] = 'Аватар должен быть картинкой размером не более 1MB!';
$LANGS['avatardeleted'] = 'Аватар успешно удален!';
...
$LANGS['captchaincorrect'] = "Вы неверно введи код.";
...
$LANGS['historycleared'] = 'Ваша история просмторов очищена.';
...
$LANGS['responseerror'] = 'Что-то пошло не так с вашим видеоответом! Проверье правильность URL.';
...
$LANGS['groupcreated'] = 'Группа усаешно создана!';
...
$LANGS['bulletindeleted'] = 'Объявление успешно удално!';
$LANGS['messagedeleted'] = 'Сообщение успешно удалено!';
$LANGS['responsedeleted'] = 'Видеоответ успешно удален!';
...
$LANGS['rating'] = 'оценка';
$LANGS['favorite'] = 'Избранные';
$LANGS['addtofav'] = 'Добавить в Избранные';
...
$LANGS['honors'] = 'Награды этого видео';
$LANGS['mostviewed'] = 'Самое Просматриваемое';
$LANGS['topfavorited'] = 'Самое Любимое';
$LANGS['times'] = 'раз';
$LANGS['mostdiscussed'] = 'Самое Обсуждаемое';
$LANGS['toprated'] = 'Наилучшая Оценка';
$LANGS['videolinks'] = 'Сайты ссылающиеся на это видео';
$LANGS['clicksfrom'] = 'щелчки с';
...
$LANGS['commentlogindesc'] = '<a href="/signup">Создайте</a> бесплатный аккаунт BitView или <a href="/login">войдите</a> если вы уже зарегистрированы.';
$LANGS['logintoresponse'] = 'Войдите чтобы добавить видеоответ';
$LANGS['logintocomment'] = 'Войдите чтобы добавить комментарий';
$LANGS['logintofav'] = 'Хотите добавить в Избранные? <a href="/login">Войдите</a> или <a href="/signup">зарегистрируйтесь</a> сейчас!';
...
$LANGS['logindesc'] = "Войти в BitView со своим аккаунтом";
$LANGS['forgot'] = "Нет доступа к вашему аккаунту?";
$LANGS['forgotmsg'] = 'Свяжитесь с нами в Twitter (@BitView_) или сообщите модераторам в Discord. (ссылка в нижней части страницы)';
...
$LANGS['nomorevideos'] = 'Видео больше не найдено...';
...
$LANGS['lastlogin'] = 'Последне входившие';
$LANGS['cstatviews'] = 'Просмотры';
$LANGS['cstatvideos'] = 'Видео';
$LANGS['cstatsubs'] = 'Подписики';
$LANGS['nochannels'] = 'Каналов больше не найдено...';
...
$LANGS['cat_KW'] = "Кувейт";
$LANGS['cat_KG'] = "Киргизстан";
$LANGS['cat_LA'] = "Лаос";
$LANGS['cat_LV'] = "Латвия";
$LANGS['cat_LB'] = "Lebanon";
$LANGS['cat_LS'] = "Lesotho";
$LANGS['cat_LR'] = "Лиьерия";
$LANGS['cat_LY'] = "Libya";
...
$LANGS['vidsfavs'] = "Видео, Избранные и Плейлисты";
...
$LANGS['videoupload'] = "Загрузка видео";
...
$LANGS['sortrating'] = "Рейтинг";
$LANGS['stattime'] = "Время";
$LANGS['statrating'] = "Рейтинг";
$LANGS['statbroadcast'] = "Вещание";
$LANGS['statrawfile'] = "Исходный файл";
$LANGS['public'] = "Публичный";
$LANGS['private'] = "Личный";
$LANGS['live'] = "В эфире!";
...
$LANGS['setasavatar'] = "Использовать превью как аватар";
...
/* Create Playlist */
$LANGS['createplaylisttitle'] = "Создать видео плейлист";
...
$LANGS['channelsubscribers'] = 'Подписчиков';
$LANGS['linkcomments'] = 'Комментарии';
$LANGS['bulletins'] = 'Посты';
$LANGS['editchannel'] = 'Редактировать канал';
$LANGS['type'] = 'Тип';
$LANGS['joined'] = 'Зарегистрирован';
$LANGS['videoswatched'] = 'Видео просмотрено';
$LANGS['channelviews'] = 'Канал просмотрен';
$LANGS['age'] = 'Возраст';
$LANGS['gender'] = 'Пол';
$LANGS['male'] = 'Мужчина';
...
$LANGS['connectwith'] = 'Подключиться через';
...
$LANGS['recentratings'] = 'Недавние оценки';
$LANGS['seeall'] = 'все';
...
$LANGS['channelcomments'] = 'Комментарии к каналу';
$LANGS['bggraphic'] = 'на фоновое изображение';
$LANGS['reportthisuser'] = 'на этого пользователя';
$LANGS['norecentratings'] = 'Недавних оценок не найдено...';
$LANGS['nosubscribers'] = 'Нед подписчиков...';
...
$LANGS['body'] = 'Текст';
$LANGS['bulletincomments'] = 'Комментарии объявления';
...
$LANGS['partnertitle'] = 'Станте партнёром BitView';
...
$LANGS['partnerbenefits'] = 'Преймущетсва партнёров';
$LANGS['partnerbenefitsdesc'] = 'Преймуществ ствновления Партнёром BitView достаточно много. Вот некоторые из них:<br><br>- Брендинг: выделитесь с помощью пользовательского брендинга, который включает в себя баннеры, пользовательский блок для вашего канала и значок партнера на всех ваших видео.<br><br>- В будущем вас ждет еще больше преимуществ!';
$LANGS['qualificationsfaq'] = 'Квалификация и ЧаВо';
$LANGS['qualificationsfaqdesc'] = 'Чтобы претендовать на участие в Партнерской Программе BitView, вы должны соответствовать некоторым минимальным критериям:<br><br>- Вы создаете оригинальные видео, подходящие для онлайн-трансляции.<br><br>- У вас более 75 подписчиков.<br><br>- Ваш аккаунт не нарушает <a href="/guidelines">Принципов Сообщества.</a>';
...
$LANGS['aboutguidelines'] = 'О Принципах BitView';
$LANGS['aboutguidelinesdesc'] = "Принципы BitView не должны требовать объяснений и должны быть просты для понимания. Они стараются аппелировать как можно большему количеству типов людей. Пожалуйста, старайтесь соблюдать наши Правил, и у вас не будет неприятностей!";
$LANGS['therules'] = 'Правила';
$LANGS['rule1'] = "Видео с изображением полового акта запрещены. То же применяется к анимации!";
$LANGS['rule2'] = "Спам в профилях, комментариях, сообщениях и жалобах запрещён.";
$LANGS['rule3'] = "Видео продвигающие экстремистские идеологии в позитивном свете запрещены.";
$LANGS['rule4'] = "Видео и имена профилей которые продвигают причинение вреда / притеснение по отношению к индивидуумам / компаниям / группам запрещены.";
$LANGS['rule5'] = "Видео и изображения профилей которые содержат расчленение, насилие, самоубийства, обезглавливания, обстрелы, убийства, раздавливание заживо и разрывы кожи запрещены. Анимированное/мультяшное насилие разрешено, до тех пор пока его нельзя признать реалистичным.";
$LANGS['rule6'] = "Видео изображающие жестокость к животным запрещены.";
$LANGS['rule7'] = "Реклама сервисов или сайтов в фоме видео или комментариев запрещена.";
$LANGS['rule8'] = "Не пытайтесь получить доступ к аккаунту, которыей вам не пренадлежит.";
$LANGS['rule9'] = "Не используйте больше одного аккаунта для оценивания видео и/или комментариев. Вам так же не разрешено использовать несколько аккаунтов для подписки на самого себя.";
$LANGS['rule10'] = "Уклонение от бана <b>НЕ</b> допускается. Новые аккаунты созданные забаненным человеком будут автоматически удалаться.";
$LANGS['rule11'] = "Передача ваших данных для входа кому либо ещё запрещена.";
$LANGS['enforceguidelines'] = "Мы следим за соблюдением этих Принципов";
$LANGS['enforceguidelinesdesc'] = "Это больше о нас, чем о вас. Команда BitView проверяет видео с жалобами примерно раз в год на факт нарушения Принципов Сообщества.
<br>Если они нарушают Принципы, мы их удаляем. Аккаунты наказываются за нарушение Приципов Сообщества и серьезные или многократные нарушения приведут к блокировке аккаунта. <br>Не пытайтесь искать лазейки для обхода этих простых Правил.";
...
$LANGS['a10'] = 'О: Мы проводим предварительный просмотр загруженных видео как в ручном, так и в автоматизированном режиме. Хотя мы делаем все возможное, чтобы обнаруживать и удалять видео, нарушающие наши правила, наш процесс проверки в первую очередь направлен на удаление контента для взрослых или очевидных нарушений авторских прав и не является пуленепробиваемым. Однако мы рекомендуем нашим зрителям уведомлять нас, когда они обнаруживают нарушения политики или проблемы с авторскими правами - у нас есть процедура рассмотрения сообщений о нарушениях политики и реагирования на сообщения о нарушениях авторских прав в соответствии с Законом об авторском праве в цифровую эпоху.';
$LANGS['q11'] = 'В: У вас есть сервер Discord или Twitter?';
$LANGS['a11'] = 'Да! На самом деле у нас есть сервер Discord и Twitter. Вы можете присоединиться к серверу Discord, кликнув <a href="https://discord.gg/wgGaqCmwuQ">здесь</a>, и подписаться на нас в Twitter <a href="https://twitter.com/bitview_">здесь</a>.';
...
$LANGS['guidelines'] = 'Приципы Сообщества';
$LANGS['partnerships'] = 'Партнерская программа';
