...
$LANGS['languagesuggestion'] = 'Предлагаемый язык (мы выбрали его для вас):';
...
$LANGS['nohistory'] = "Вы ещё не смотрели никаких видео в этой сессии!";
...
$LANGS['forgotmsg'] = 'Свяжитесь с нами через Twitter (@BitView_) или сообщите модераторам в Discord. (ссылка в нижней части страницы)';
...
$LANGS['topostatopic'] = "чтобы созать обсуждение.";
$LANGS['topic'] = "Тема";
$LANGS['author'] = "Автор";
...
$LANGS['channelviews'] = 'Просмоторов канала';
$LANGS['age'] = 'Возраст';
$LANGS['gender'] = 'Пол';
$LANGS['male'] = 'Мужчина';
...
$LANGS['clicktosend'] = 'Щёлкните для отправки!';
...
$LANGS['contentpartners'] = 'Контент-партнёры';
$LANGS['partnerbenefits'] = 'Преймущетсва партнёров';
$LANGS['partnerbenefitsdesc'] = 'Преймуществ ствновления Партнёром BitView достаточно много. Вот некоторые из них:<br><br>- Брендинг: выделитесь с помощью пользовательского брендинга, который включает в себя баннеры, пользовательский блок для вашего канала и значок партнера на всех ваших видео.<br><br>- В будущем вас ждет ещё больше преимуществ!';
$LANGS['qualificationsfaq'] = 'Квалификация и ЧаВо';
$LANGS['qualificationsfaqdesc'] = 'Чтобы претендовать на участие в Партнерской Программе BitView, вы должны соответствовать некоторым минимальным критериям:<br><br>- Ваши видео оригинальны и подходят для веб-трансляции.<br><br>- У вас более 75 подписчиков.<br><br>- Ваш аккаунт не нарушает <a href="/guidelines">Принципов Сообщества.</a>';
...
От имени всей команды BitView я хотел бы выразить свою сердечную благодарность за вашу исключительную самоотверженность и трудолюбие. Как один из владельцев, я испытываю огромную гордость, наблюдая за ростом и успехом нашей платформы для обмена видео, и это было бы невозможно без вашего бесценного вклада.
                ...
                <br><br>
                Ещё раз благодарю вас: совладельцев, разработчиков и модераторов, за вашу непоколебимую преданность делу, опыт и неизменную поддержку. Ваша тяжелая работа не осталась незамеченной, и я невероятно горжусь тем, что являюсь частью этой замечательной команды.
                <br><br>
...
$LANGS['about3'] = 'Заружать в блоги видео снятые на ваш телефон или камеру';
...
$LANGS['rule1'] = "Видео сексуального характера запрещены. То же применяется к анимации.";
...
$LANGS['a9'] = "О: Мы сообщим вам, если получим жалобу на нарушение авторских прав в отношении любого вашего видеоконтента, размещённого на BitView. Мы дадим вам возможность отреагировать соответствующим образом.";
...
$LANGS['a11'] = 'Да! У нас действительно нас сервер Discord и Twitter. Вы можете присоединиться к серверу Discord, кликнув <a href="https://discord.gg/wgGaqCmwuQ">здесь</a>, и подписаться на нас в Twitter <a href="https://twitter.com/bitview_">здесь</a>.';
...
$LANGS['sharevideo3'] = '1. <b>URL</b>: Этот URL отправит вас непосредственно на страницу BitView и начнёт воспроизводить видео. Отправьте ссылку кому-то через e-mail или в программах чата.';
$LANGS['sharevideo4'] = '2. <b>Виджет</b>: Скопируйте HTML-код ниже на свой веб-сайт, и на нем появится видеоплеер BitView. Он не будет воспроизводиться автоматически, и на него нужно будет кликнуть, чтобы начать воспроизведение. Замените <i>"XXXXX"</i> на ID видео.';
$LANGS['sharepvideo1'] = "Чтобы друзья и семья могли смотреть ваши личные видео, у них, прежде всего, должна быть учетная запись BitView. После того, как вы узнаете имя учетной записи, перейдите на их канал и нажмите кнопку <i>Добавить в друзья</i> справа. Теперь им просто нужно одобрить запрос в друзья, и они будут готовы к просмотру ваших личных видео.<br><b>Вы также можете добавить друга, просто введя его имя пользователя ниже:</b>";
$LANGS['sharechannellist1'] = 'Получить список всех загруженных вами видео BitView очень просто, просто добавьте этот HTML-виджет на свой веб-сайт.';
