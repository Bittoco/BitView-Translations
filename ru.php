<?php
/* General stuff */
$LANGS['language'] = 'Русский';
$LANGS['languageenglish'] = 'Russian';
$LANGS['languagecode'] = 'ru_RU';
$LANGS['languagechange'] = 'Язык был установлен на Русский.';
...
/* Language window */
$LANGS['welcometobitview'] = 'Добро пожаловать в BitView!';
$LANGS['languagesuggestion'] = 'Предлагаемый язык (мы выбрали его для вас):';
$LANGS['languagesuggestiondesc1'] = 'Чтобы изменить свои настройки языка, воспользуйтесь переключателем языков в нижней сноске (в конце страницы)';
$LANGS['languagesuggestiondesc2'] = 'Нажмите "OK" чтобы принять настройки, нажмите "Отмена" чтобы продолжить видеть сайт на английском языке.';
...
$LANGS['login'] = 'Войти';
$LANGS['or'] = 'или';
$LANGS['signup'] = 'Зарегестрироваться';
$LANGS['logout'] = 'Выйти';
...
$LANGS['videoviews'] = 'простмотров';
$LANGS['beingwatched'] = 'Видео просматриваемые сейчас';
$LANGS['featured'] = 'Рекоммендуемые видео';
$LANGS['mostpopular'] = 'Популярное';
...
$LANGS['totalviews'] = 'Общее количество просмотров';
$LANGS['sendmessage'] = 'прислать сообщение';
$LANGS['whatsnew'] = "Что нового";
$LANGS['readmore'] = 'Подробнее в нашем блоге';
$LANGS['videocontest'] = 'Видеоконкурс';
$LANGS['joincontest'] = 'Присоединяйтесь к конкурсу прямо сейчас!';
$LANGS['personalize'] = 'Хотите персонализировать эту домашнюю страницу?';
$LANGS['signinnow'] = '<a href="/login">Войдите</a> или <a href="/signup">Зарегестрируйтесь</a> сейчас!';
$LANGS['nowconverting'] = "Это видео конвертируеться, подождите несколько минут.";
...
$LANGS['historytitle'] = "История просмотра";
...
$LANGS['addvideoplaylist2'] = 'видео в свой плейлист!';
$LANGS['addfavorite1'] = "Вам понравились";
$LANGS['addfavorite2'] = 'видео!';
$LANGS['groupdoesnotexist'] = "Это группа не существует!";
$LANGS['uploaddisabled'] = 'Загрузка видео была времмено отключена для обслуживания.';
$LANGS['10vidsday'] = 'Вы не можете загружать больше 10 видео в день! Попробуйте завтра.';
$LANGS['3mins'] = 'Подождите 3 минуты для загрузки нового видео!';
$LANGS['backgroundsuccess'] = 'Фон был успешно загружён!';
$LANGS['backgrounderror'] = 'Фоновое изображение должно быть менее 2МБ и представлять собой файл изображения!';
$LANGS['backgrounddeleted'] = 'Фон был успешно удалён!';
$LANGS['bannersuccess'] = 'Баннер был успешно загружён!';
$LANGS['bannererror'] = 'Изображение баннера должно быть менее 2 МБ и представлять собой файл изображения!';
$LANGS['bannerdeleted'] = 'Ваш баннер был успешно удалён!';
$LANGS['minibannersuccess'] = 'Мини-баннер был успешно загружен!';
$LANGS['minibannererror'] = 'Изображение мини-баннера должно быть менее 2 МБ и представлять собой файл изображения!';
$LANGS['minibannerdeleted'] = 'Ваш мини-баннер был успешно удалён!';
