...
$LANGS['nofavvideos'] = "Вы не добавляли видео в Избранные...";
...
$LANGS['grouptype'] = "Тип";
$LANGS['instantjoin'] = "Мгновенное присоединение";
$LANGS['approvalrequired'] = "Требуется подтверждение";
$LANGS['groupurl'] = "URL";
...
$LANGS['approvemembers'] = "Принять участников";
$LANGS['approvevideos'] = "Принять видео";
$LANGS['yes'] = "Да";
$LANGS['no'] = "Нет";
...
$LANGS['uploaddesc1'] = 'Загрузка обычно занимает 1-2 минуты на МБ при высокоскоростном подклбчении, и конвертация может занять несколько минут.';
...
$LANGS['partnerdesc'] = "У вас отличные видео и растущая аудитория. Позвольте BitView помочь вам вынйти на новый уровень с нашей Партнёрской Программой.";
