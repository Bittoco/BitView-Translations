...
$LANGS['recommendedforyou'] = 'Рекомендуем Вам';
...
$LANGS['customizehomepage'] = "Настроить Главную";
$LANGS['customizethehomepage'] = "Настроить лавнуб";
$LANGS['customizehomepagedesc'] = "Выберите разделы, которые вы хотите видеть на своей Главной.";
$LANGS['displaypreferences'] = "Настройки отображения";
$LANGS['thefeed'] = "Лента";
$LANGS['thefeeddesc'] = "Объединить все разделы в единую ленту.";
$LANGS['friendactivitytitle'] = "Активность друзей - Могут ли другие видеть что я делаю?";
$LANGS['friendactivitydesc'] = "Этот раздел показывает вашим подтверждённым друзьям вашу публичную историю действий. Например, если вы добавите видео в Избранное, это действие появится в разделе Недавние действия на каналах ваших друзей, а так же их Главных страницах";
$LANGS['feedfeatured'] = "В центре внимания";
$LANGS['feedbeingwatched'] = "Сейчас смотрит";
$LANGS['feedrecommended'] = "Рекомендованное видео";
$LANGS['nosubscriptions'] = "Вы ещё не подписаны ни на какие каналы.";
$LANGS['nosubscriptionsdesc'] = "Когда вы добавите новые подписки, мы покажем их видео на этой странице.";
$LANGS['nofriendactivity'] = "Ваши друзья не были активны за последнее время.";
$LANGS['nofriendactivitydesc'] = "Попробуйте добавить пару друзей. Тогда мы покажем их акивность на этой странице.";
...
$LANGS['aboutguidelinesdesc'] = "Принципы BitView не должны требовать объяснений и должны быть просты для понимания. Они стараются аппелировать как можно большему количеству типов людей. Пожалуйста, старайтесь соблюдать наши Правила, и у вас не будет неприятностей!";
$LANGS['therules'] = 'Правила';
$LANGS['rule1'] = "Видео с изображением полового акта запрещены. Это же применяется к анимации!";
...
$LANGS['rule7'] = "Реклама сервисов или сайтов в форме видео или комментариев запрещена.";
$LANGS['rule8'] = "Не пытайтесь получить доступ к аккаунту, который вам не принадлежит.";
...
$LANGS['rule10'] = "Уклонение от бана <b>НЕ</b> допускается. Новые аккаунты созданные забаненным человеком будут автоматически удаляться.";
...
<br>Если они нарушают Принципы, мы их удаляем. Аккаунты наказываются за нарушение Принципов Сообщества и серьезные или многократные нарушения приведут к блокировке аккаунта. <br>Не пытайтесь искать лазейки для обхода этих простых Правил.";
...
$LANGS['sharechannellist'] = 'Как мне разместить список моих видеороликов BitView на моем веб-сайте?';
...
$LANGS['sharevideo3'] = '1. <b>URL видео</b>: Этот URL отправит вас непосредственно на страницу просмотра видео и мгновенно начнет воспроизведение видео. Отправьте ссылку кому-нибудь по электронной почте или в мессенджере.';
$LANGS['sharevideo4'] = '2. <b>Встроить</b>: Скопируйте приведенный ниже HTML-код на свой веб-сайт, и на нем появится видеоплеер BitView. Он не будет воспроизводиться автоматически, и на него нужно нажать, чтобы начать просмотр видео. Замените <i>"XXXXX"</i> на идентификатор видео.';
...
$LANGS['sharechannellist1'] = 'Получить список всех загруженных вами видео BitView очень просто, просто добавьте этот HTML-фрагмент на свой веб-сайт.';
