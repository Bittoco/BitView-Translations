...
$LANGS['flagmod'] = 'Вы не можете пожаловаться на пользователя с привилегиями модератора!';
...
$LANGS['featuredtext'] = 'Это рекомендованное видео. Хотите посмотреть больше таких видео? <a href="/browse?t=2">Кликните здесь</a>.';
...
$LANGS['signindesc4'] = "Загружать в блоги видео снятые на ваш телефон или камеру";
...
$LANGS['aboutguidelinesdesc'] = "Принципы BitView не должны требовать объяснений и должны быть просты для понимания. Они стараются апеллировать как можно большему количеству типов людей. Пожалуйста, старайтесь соблюдать наши Правил, и у вас не будет неприятностей!";
