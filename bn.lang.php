<?php
/* General stuff */
$LANGS['language'] = 'বাংলা';
$LANGS['languageenglish'] = 'বাংলা';
$LANGS['languagecode'] = 'bn_BD.UTF-8'; /* Leave the ".UTF-8" in the end as-is, as it might break some dates */
$LANGS['languagechange'] = 'ভাষাটি বাংলায় সেট করা হয়েছে।';
...
/* Language window */
$LANGS['welcometobitview'] = 'BitView-তে স্বাগতম। ';
$LANGS['languagesuggestion'] = 'প্রস্তাবিত ভাষা (আমরা আপনার প্রেফারেন্সে এটি সেট করেছি):';
$LANGS['languagesuggestiondesc1'] = 'ভাষার প্রেফারেন্স পরিবর্তন করতে চাইলে ল্যাঙ্গুয়েজ সিলেক্টর ফুটার ব্যবহার করুন (পেজের শেসে রয়েছে)।';
$LANGS['languagesuggestiondesc2'] = 'এরকমি রাকতে "OK" ক্লিক করুন, or click "Cancel" to view the site in English.';

/* Time, dates, etc */
$LANGS['second'] = 'সেকেন্ড';
$LANGS['minute'] = 'মিনিট';
$LANGS['hour'] = 'ঘন্টা';
$LANGS['day'] = 'দিন';
$LANGS['week'] = 'সপ্তাহ';
...
$LANGS['years'] = 'বছর';
$LANGS['ago'] = '{t} আগে';
$LANGS['january'] = 'জানুয়ারি';
$LANGS['february'] = 'ফেব্রুয়ারী';
$LANGS['march'] = 'মার্চ';
$LANGS['april'] = 'এপ্রিল';
$LANGS['may'] = 'মে';
$LANGS['june'] = 'জুন';
$LANGS['july'] = 'জুলাই';
$LANGS['august'] = 'আগস্ট';
$LANGS['september'] = 'সেপ্টেম্বর';
$LANGS['october'] = 'অক্টোবর';
$LANGS['november'] = 'নভেম্বর';
$LANGS['december'] = 'ডিসেম্বর';
...
$LANGS['home'] = 'হোম';
$LANGS['videos'] = 'ভিডিও';
$LANGS['channels'] = 'চ্যানেল';
$LANGS['community'] = 'কমিউনিটি';
$LANGS['search'] = 'সার্চ';
$LANGS['login'] = 'সাইন ইন করুন';
$LANGS['or'] = 'অথবা';
$LANGS['signup'] = 'আকাউন্ত তৈরি করুন';
$LANGS['logout'] = 'লগ আউট করুণ';
$LANGS['upload'] = 'আপলোড করুন';
$LANGS['subscriptions'] = 'সাবস্ক্রিপশন';
$LANGS['history'] = 'ইতিহাস';
$LANGS['account'] = 'আকাউন্ত';
$LANGS['myvideos'] = 'আমার ভিডিও';
$LANGS['favorites'] = 'পছন্দর ভিডিও';
$LANGS['playlists'] = 'প্লেলিস্ট';
$LANGS['help'] = 'সাহায্য';
$LANGS['suggestions'] = 'পরামর্শ';
$LANGS['quicklist'] = 'কুইক্লিস্ট';
$LANGS['browse'] = 'ব্রাউজ করুন';
$LANGS['messagesmenu'] = 'বার্তা';
$LANGS['myvideos&playlists'] = 'আমার ভিডিও এবং প্লেলিস্ট';

/* Homepage */
$LANGS['viewall'] = 'সবগুলো দেখুন';
$LANGS['videoviews'] = 'দর্শক';
$LANGS['beingwatched'] = 'এখন যেসব ভিডিও দেখা হচ্ছে';
$LANGS['featured'] = 'ফিচার্ড ভিডিওগুলি';
$LANGS['recommendedforyou'] = 'আপনার জন্য প্রস্তাবিত';
$LANGS['mostpopular'] = 'সর্বাধিক দেখা';
$LANGS['inboxstats'] = 'ইনবক্স এবং পরিসংখ্যান';
$LANGS['profilesettings'] = 'অ্যাকাউন্ট সেটিংস';
$LANGS['messages'] = 'বার্তাগুলি';
$LANGS['message'] = 'বার্তা';
$LANGS['comments'] = 'কমেন্টস';
$LANGS['comment'] = 'কমেন্ট';
$LANGS['sharedwithyou'] = 'আপনার সাথে শেয়ার করা হয়েছে';
$LANGS['sharedwithyousingular'] = 'আপনার সাথে শেয়ার করা হয়েছে';
...
$LANGS['subscribers'] = 'সাবস্ক্রাইবার';
$LANGS['subscriber'] = 'সাবস্ক্রাইবার';
$LANGS['totalviews'] = 'মোট ভিউস';
$LANGS['sendmessage'] = 'মেসেজ সেন্ড করুণ';
$LANGS['whatsnew'] = "নতুন কি?";
...
$LANGS['signinnow'] = '<a href="/login">লগ ইন করুণ</a> or <a href="/signup">রেজিস্টার করুণ</a> now!';
$LANGS['nowconverting'] = "This video is converting, wait a few minutes.";
$LANGS['modules'] = "মডিউল সেট করুণ";
$LANGS['friendactivity'] = "Friend Activity";
$LANGS['customizehomepage'] = "হোমপেজ কাস্তুমাইস করুণ";
$LANGS['customizethehomepage'] = "হোমপেজটি কাস্তুমাইস করুণ";
...
$LANGS['thefeed'] = "ফিড";
$LANGS['thefeeddesc'] = "সব মডিইউল মিলিয়ে একটি ফিড বানান.";
...
/* Page title */
$LANGS['hometitle'] = "{n} এর বিটভিউ";
$LANGS['channeltitle'] = "{n} এর চ্যানেল";
$LANGS['signintitle'] = "লগ ইন করুণ";
$LANGS['historytitle'] = "ভিউ রেকর্ড";
$LANGS['favtitle'] = "পছন্দ করা ভিডিও";
$LANGS['pltitle'] = "প্লেলিস্ট";
$LANGS['partnerprogram'] = "পার্টনার প্রগরাম";

/* Notifications */
$LANGS['404error'] = "দুঃখিত, পেজটি খুঁজে পাওয়া গেলো না। :(";
...
/* Countries */
$LANGS['cat_AF'] = "আফঘানিস্তান";
$LANGS['cat_AX'] = "অলান্দ দ্বীপপুঞ্জ";
$LANGS['cat_AL'] = "আলবেনিয়া";
$LANGS['cat_DZ'] = "আলজেরিয়া";
$LANGS['cat_AS'] = "মার্কিন সামোয়া";
$LANGS['cat_AD'] = "অ্যান্ডোরা";
$LANGS['cat_AO'] = "অ্যাঙ্গোলা";
$LANGS['cat_AI'] = "আঙ্গুইল্লা";
$LANGS['cat_AQ'] = "অ্যান্টার্কটিকা";
$LANGS['cat_AG'] = "অ্যান্টিগা_ও_বার্বুডা";
$LANGS['cat_AR'] = "আর্জেন্টিনা";
$LANGS['cat_AM'] = "আরমেনিয়া";
$LANGS['cat_AW'] = "আরুবা";
$LANGS['cat_AU'] = "অস্ট্রেলিয়া";
$LANGS['cat_AT'] = "আউস্ত্রিয়া";
$LANGS['cat_AZ'] = "আজারবাইজান";
$LANGS['cat_BS'] = "বাহামাস";
$LANGS['cat_BH'] = "বাহরাইন";
$LANGS['cat_BD'] = "বাংলাদেশ";
$LANGS['cat_BB'] = "বার্বাডোস";
$LANGS['cat_BY'] = "বেলারুশ";
$LANGS['cat_BE'] = "বেলজিয়াম";
$LANGS['cat_BZ'] = "বেলিজ";
$LANGS['cat_BJ'] = "বেনিন";
